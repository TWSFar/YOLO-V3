...
def train():
    ...
    if weights.endswith('.pt'):  # pytorch format
        ...
        if chkpt['optimizer'] is not None:
            ...
            bset_fitness = chkpt['best_fitness']
    ...
    # Dataset
    dataset = LoadImagesAndLabels(opt.root_path,
                                  img_size,
                                  batch_size,
    ...
    nb = len(dataloader) # number of batch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default="/home/twsf/data/Visdrone", help='path of datasets')
    ...
    if opt.prebias:
        ...
        opt.prebias = False  # diable prebias
